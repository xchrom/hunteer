...
function checkGmail($mail){
  ...
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
    'User-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 14_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/87.0.4280.60 Mobile/15E148 Safari/604.1',
...
'Expect: 100-continue',
  ...
  // echo $mail;
  $fields = '{"input01":{"Input":"GmailAddress","GmailAddress":"'.$mail.'","FirstName":"'.str_shuffle('Saad').'","LastName":"'.str_shuffle('Saad').'"},"Locale":"en"}';
